          ...
          <div style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            {report.additionalObservations && (
              <div style={{
                ...
                <div style={{ fontSize: "10px", fontWeight: "600", color: "#f59e0b", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "8px" }}>
                  Additional Observations (Worker Notes)
                </div>
                <div style={{ fontSize: "13px", color: "#d1d5db", lineHeight: "1.5" }}>
                  {report.additionalObservations}
                </div>
                <div style={{ fontSize: "11px", color: "#6b7280", marginTop: "8px" }}>
                  ⚠ These observations were not used for triage classification. For clinical evaluation only.
                </div>
              </div>
            )}
